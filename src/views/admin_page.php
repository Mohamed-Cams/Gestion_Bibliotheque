    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <img src="../Images/open-book-svgrepo-com.svg" alt="Bootstrap" width="50" height="54" />
                </a>
        ...
        <form action="search.php" method="get" style="width: 100%; max-width: 30rem">
            ...
            <div class="input-group my-5">
                <input type="text" class="form-control" name="key" placeholder="Rechercher livre..." aria-label="Rechercher livre..." aria-describedby="basic-addon2">
